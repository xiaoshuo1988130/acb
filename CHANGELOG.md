...
- Reworked the English and Simplified Chinese README opening sections into mobile-friendly value blocks, start paths, trust-boundary blocks, and handoff-flow steps.
...
- Extracted setup recipes, target detection, and setup guide generation from `bin/acb.js` into `lib/setup-guides.js`.
